...
## REQ-DS-001: 数据源 Data Model

**Requirement:** 系统应维护数据源配置的完整数据模型。
...
**Requirement:** 用户可以上传本地文件作为 Pipeline 数据源。
...
## REQ-DS-003: Azure Blob Storage 数据源

**Requirement:** 用户可以配置 Azure Blob Storage 作为数据源。
