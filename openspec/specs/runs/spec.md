...
用户可以同步执行 Pipeline 处理少量文档，用于快速测试和调试。
...
用户可以查看 Pipeline 执行过程中每个步骤的输入、输出和状态。
...
系统保留 Pipeline 每一步的中间结果，支持查看、删除和定期清理。
...
### Requirement: Run 历史管理

用户可以查看和管理 Pipeline 的运行历史。
